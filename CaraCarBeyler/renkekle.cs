...
namespace CaraCarBeyler
{
    public partial class renkekle : Form
    {
        ...
        private void renkekle_Load(object sender, EventArgs e)
        {
            doldur();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd.CommandText = "SELECT ID FROM AracRenk WHERE Renk='" + comboBox1.Text + "'";
                okuyucubey = cmd.ExecuteReader();
                if (okuyucubey.Read())
                {
                    MessageBox.Show("Bu Araç Renginden Bulunmaktadır");
                    okuyucubey.Close();
                }
                else
                {
                    ...
                    ekle.CommandText = "INSERT INTO AracRenk(Renk)VALUES(@Renk)";
                    ekle.Parameters.AddWithValue("@Renk", comboBox1.Text);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            komut.CommandText = "DELETE FROM AracRenk WHERE Renk = '" + comboBox1.SelectedItem + "'";
        ...
        private void renkekle_FormClosing(object sender, FormClosingEventArgs e)
        {
            ayarlar ayar = new ayarlar();
            this.Hide();
            ayar.Show();
